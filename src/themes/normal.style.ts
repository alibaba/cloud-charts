export default {
  ...
  'widgets-font-family-txd-m-number':
    "'TXDDINMediumNumber', 'Helvetica Neue', 'Helvetica', 'PingFang SC', 'Microsoft YaHei', 'Arial', sans-serif",
  'widgets-font-family-txd-r-number':
    "'TXDDINRegularNumber', 'Helvetica Neue', 'Helvetica', 'PingFang SC', 'Microsoft YaHei', 'Arial', sans-serif",
  ...
  'widgets-numbercard-color-bg': '#f7f7f7',
