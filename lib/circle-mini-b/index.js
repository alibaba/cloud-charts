...
var CircleMiniB = (_temp = _class = function (_React$Component) {
  _inherits(CircleMiniB, _React$Component);

  function CircleMiniB() {
    _classCallCheck(this, CircleMiniB);

    return _possibleConstructorReturn(this, (CircleMiniB.__proto__ || Object.getPrototypeOf(CircleMiniB)).apply(this, arguments));
  }

  _createClass(CircleMiniB, [{
    key: 'renderCell',
...
CircleMiniB.displayName = 'CircleMiniB';
exports.default = CircleMiniB;
