    ...
    _createClass(AiscChart, [{
      ...
      value: function componentDidMount() {
        if (this.props.customChart) {
          Chart = _extends({}, Chart, this.props.customChart);
        }
        ...
        var data = convertData ? config.dataType !== 'Highcharts' ? initData : highchartsDataToG2Data(initData) : initData;
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (newData !== oldData || newData.length !== oldData.length) {
          var data = convertData ? newConfig.dataType !== 'Highcharts' ? newData : highchartsDataToG2Data(newData) : newData;
