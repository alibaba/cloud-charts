...
(function (root, factory) {
    ...
    extend: {
      ...
      , initAnimations: function initAnimations() {
        ...
        for (i in s.animations) {
          ...
          // of a SVG.Number
          if (s.animations[i] instanceof SVG.Number) source = new SVG.Number(source);
  ...
  SVG.Matrix = SVG.invent({
    ...
    create: function create(source) {
      ...
      source = source instanceof SVG.Element ? source.matrixify() : typeof source === 'string' ? stringToMatrix(source) : arguments.length == 6 ? arrayToMatrix([].slice.call(arguments)) : Array.isArray(source) ? arrayToMatrix(source) : (typeof source === 'undefined' ? 'undefined' : _typeof(source)) === 'object' ? source : base;
    ...
    , extend: {
      ...
      , flip: function flip(a, o) {
        ...
        return a == 'x' ? this.scale(-1, 1, o, 0) : a == 'y' ? this.scale(1, -1, 0, o) : this.scale(-1, -1, o, o);
      }
      // Skew
  ...
  SVG.extend(SVG.FX, {
    transform: function transform(o, relative) {
      ...
      if (o.a != null) {
        ...
        matrix = new SVG.Matrix().flip(o.flip, o.offset == null ? target.bbox()['c' + o.flip] : o.offset);
  ...
  SVG.extend(SVG.Polyline, SVG.Polygon, {
    ...
    , plot: function plot(p) {
      return p == null ? this.array() : this.attr('points', this._array = new SVG.PointArray(p));
    }
    // Move by left top corner
    , move: function move(x, y) {
  ...
  SVG.Path = SVG.invent({
    ...
    , extend: {
      ...
      , plot: function plot(p) {
        return p == null ? this.array() : this.attr('d', this._array = new SVG.PathArray(p));
      }
      // Move by left top corner
      , move: function move(x, y) {
