...
var ButtonMiniA = (_temp = _class = function (_React$Component) {
  _inherits(ButtonMiniA, _React$Component);

  function ButtonMiniA(props) {
    _classCallCheck(this, ButtonMiniA);

    var _this = _possibleConstructorReturn(this, (ButtonMiniA.__proto__ || Object.getPrototypeOf(ButtonMiniA)).call(this, props));

    _this.onClick = _this.onClick.bind(_this);
    return _this;
  }

  _createClass(ButtonMiniA, [{
    key: 'onClick',
...
ButtonMiniA.displayName = 'ButtonMiniA';
exports.default = ButtonMiniA;
