...
var NumberMiniG = (_temp = _class = function (_React$Component) {
  _inherits(NumberMiniG, _React$Component);

  _createClass(NumberMiniG, [{
    key: 'renderCell',
  ...
  function NumberMiniG(props) {
    _classCallCheck(this, NumberMiniG);

    var _this = _possibleConstructorReturn(this, (NumberMiniG.__proto__ || Object.getPrototypeOf(NumberMiniG)).call(this, props));
...
NumberMiniG.displayName = 'NumberMiniG';
exports.default = NumberMiniG;
