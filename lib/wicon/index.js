...
var Wicon = (_temp = _class = function (_React$Component) {
  ...
  Wicon.prototype.render = function render() {
    ...
    var classes = (0, _classnames2.default)((_classNames = {}, _classNames[prefix + '-' + type] = !!type, _classNames['' + prefix] = true, _classNames[prefix + '-' + size] = !!size, _classNames[prefix + '-' + (0, _common.getStatusColorName)(status)] = !!status, _classNames[prefix + '-reverse'] = !!reverse, _classNames[className] = !!className, _classNames));
