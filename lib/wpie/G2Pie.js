...
function getDrawPadding(drawPadding, label) {
  if (Array.isArray(drawPadding)) {
    ...
    return defaultConfig.drawPadding.map(function (p) {
...
exports.default = {
  beforeInit: function beforeInit(props) {
    ...
    var drawPadding = getDrawPadding(config.drawPadding, config.label);
  ...
  init: function init(chart, userConfig, data) {
    ...
    _rectLegend2.default.call(this, chart, config, {
      ...
      'g2-legend': _extends({}, _g2Theme.legendHtmlContainer, {
        ...
        marginLeft: Math.max((0, _common.pxToNumber)(_index2.default.s5) - drawPadding, 0) + 'px'
      }),
