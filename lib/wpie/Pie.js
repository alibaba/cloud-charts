...
var Pie = function (_Base) {
  ...
  _createClass(Pie, [{
    ...
    value: function render() {
      ...
      var titleNode = this.element.querySelector('.p2c-title');
      var boxNode = this.element.querySelector('.p2c-box');
      var legendNode = this.element.querySelector('.p2c-legend');

      //位置计算
      var titleHeight = titleNode ? titleNode.offsetHeight : 0;
      var boxHeight = this.element.offsetHeight - this.options.padding * 2 - titleHeight - 20; //此处没有计算margin，默认为20
