...
var barConfig = {
  ...
  beforeInit: function beforeInit(props) {
    ...
    var newConfig = (0, _merge2.default)({}, defaultConfig, props.config);
  ...
  renderTooltip: function renderTooltip(data, canvas, config, self, elem) {
    ...
    if (!topContentDiv) {
      ...
      var parentContainer = document.getElementById((0, _f2Utils.getContainerId)(elem.chartId));
  ...
  removeTooltip: function removeTooltip(self, elem) {
    ...
    var tooltip = document.querySelector('#' + (0, _f2Utils.getTooltipId)(elem.chartId));
    if (tooltip) {
  ...
  drawGuideLine: function drawGuideLine(data, elem, canvas, config) {
    ...
    var container = document.querySelector('#' + (0, _f2Utils.getContainerId)(elem.chartId));
