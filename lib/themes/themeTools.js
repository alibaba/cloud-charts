...
exports.setG2Theme = setG2Theme;

var _core = require("@antv/g2/esm/core");

var _createByStyleSheet = require("@antv/g2/esm/theme/util/create-by-style-sheet");
...
function getG2StyleSheet(theme) {
  var fontSize1 = (0, _common.pxToNumber)(theme['widgets-font-size-1']);
  var BLACK_COLORS = {
    100: '#000',
    95: '#0D0D0D',
    85: '#262626',
  ...
  var QUALITATIVE_10 = [theme['widgets-color-category-1'], theme['widgets-color-category-2'], theme['widgets-color-category-3'], theme['widgets-color-category-4'], theme['widgets-color-category-5'], theme['widgets-color-category-6'], theme['widgets-color-category-7'], theme['widgets-color-category-8'], theme['widgets-color-category-9'], theme['widgets-color-category-10']];
  ...
  return {
    ...
    /** 图例 'line' marker 半径 */
    legendLineMarkerSize: fontSize1 / 3,
    // CHECK 图例项标记样式
    ...
    /** tooltip 内容框圆角 */
    tooltipContainerBorderRadius: (0, _common.pxToNumber)(theme['widgets-tooltip-corner-radius']),
    ...
    labelLineBorderColor: theme['widgets-label-text'],
    // CHECK
    // -------------------- Geometry 图形样式--------------------
...
function setG2Theme(theme) {
  var g2StyleSheet = getG2StyleSheet(theme);
  var g2Theme = (0, _createByStyleSheet.createThemeByStyleSheet)(g2StyleSheet); // g2Theme.maxColumnWidth = 36;

  var baseFontSize = theme['widgets-font-size-1'];
  var baseFontSizeNum = (0, _common.pxToNumber)(theme['widgets-font-size-1']);
  var tooltipStyle = g2Theme.components.tooltip.domStyles;
  ...
  (0, _core.registerTheme)('default', g2Theme);
}