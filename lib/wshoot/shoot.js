...
var _tween = _interopRequireDefault(require("../common/tween"));
...
Shoot.prototype = {
  ...
  draw: function draw(data) {
    ...
    for (var i = 0; i < l; i++) {
      var d = data[i];
      fCo = (0, _extends2["default"])({}, d[keys.from]);
      tCo = (0, _extends2["default"])({}, d[keys.to]); // 设置了 getPosition 函数，需要处理一遍
    ...
    this.tween = (0, _tween["default"])(generateUniqueId(), {
      duration: interval,
