...
function getHCOptions(options, data) {
  ...
  var config = {
    ...
    xAxis: {
      ...
      gridLineColor: _normal.color.colorN13,
      tickPixelInterval: 70,
      lineColor: _normal.color.colorN16,
      tickLength: 0,
      labels: {
        autoRotation: false,
        y: 20,
...
function getYAxis(options, data, yAxis, index) {
  ...
  return {
    ...
    lineColor: index === undefined ? _normal.color.colorN16 : getYAxisColor(options, data, index),
