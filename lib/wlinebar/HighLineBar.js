...
function getHCOptions(options, data) {
  ...
  var config = {
    ...
    tooltip: {
      ...
      useHTML: true,
      backgroundColor: _normal.color.colorTransparent,
      borderColor: _normal.color.colorTransparent,
      shadow: false
    },
    legend: false,
    xAxis: {
      ...
      gridLineColor: _normal.color.colorFill12,
      tickPixelInterval: 70,
      lineColor: _normal.color.colorLine12,
      tickLength: 0,
      labels: {
        autoRotation: false,
        y: 20,
        ...
        style: { fontFamily: _normal.fonts.fontFamilyBase, fontSize: _normal.fonts.fontSizeBaseCaption, color: '#989898' }
      },
      minPadding: 0,
    ...
    plotOptions: {
        ...
        marker: {
          ...
          states: {
            hover: {
              lineWidthPlus: 0,
              radiusPlus: 0,
              fillColor: _normal.color.colorWhite,
              lineWidth: 2,
              radius: 3.5,
      ...
      series: {
        ...
        dataLabels: {
          ...
          shadow: false,
          // inside: false,
          style: { fontFamily: _normal.fonts.fontFamilyBase, fontWeight: _normal.fonts.fontWeightRegular, fontSize: _normal.fonts.fontSizeBaseCaption, color: '#989898' },
          formatter: function formatter() {
...
function getYAxis(options, data, yAxis, index) {
  ...
  return {
    ...
    lineColor: index === undefined ? _normal.color.colorLine12 : getYAxisColor(options, data, index),
...
function getYAxisColor(options, data, index) {
  ...
  return _normal.color.colorLine12;
}
