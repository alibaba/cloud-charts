...
exports.default = {
  ...
  init: function init(chart, userConfig, data) {
    ...
    var legendItemStyle = _extends({}, _g2Theme.legendHtmlListItem);
    if (config.legend !== false) {
      ...
      if (align === 'right') {
        legendStyle.marginLeft = _index2.default.s3;
      } else if (align === 'left') {
        legendStyle.marginRight = _index2.default.s3;
      ...
      if (position === 'bottom') {
        ...
        legendItemStyle.marginTop = _index2.default.s3;
      }
    }
