...
var Wcircle = (_temp = _class = function (_React$Component) {
  ...
  Wcircle.prototype.renderMain = function renderMain(title, unit, children, trend, type, percent, radius, strokeWidth, status, customColor, backgroundColor, bottomTitle, bottomUnit, bottomNumber, bottomTrend) {
    var numberTrendIcon = void 0;
  ...
  Wcircle.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        otherProps = _objectWithoutProperties(_props, ['className', 'style', 'trend', 'type', 'percent', 'radius', 'strokeWidth', 'status', 'color', 'backgroundColor', 'title', 'unit', 'children', 'bottomTitle', 'bottomUnit', 'bottomNumber', 'bottomTrend']);
    ...
    return _react2.default.createElement(
      ...
      this.renderMain(title, unit, children, trend, type, percent, radius, strokeWidth, status, color, backgroundColor, bottomTitle, bottomUnit, bottomNumber, bottomTrend)
    );
  };
