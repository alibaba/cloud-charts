...
Wcircle.propTypes = {
  ...
  status: _propTypes2.default.oneOf(['blue', 'orange', 'red']),
  // 半径
  radius: function radius(props, propName, componentName) {
    if (!(props[propName] >= 10 && props[propName] <= 100)) {
      return new Error('Validation failed!');
    }
  },
  // 粗细
  strokeWidth: function strokeWidth(props, propName, componentName) {
