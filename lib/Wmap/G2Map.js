...
exports.CUSTOM_NAME = exports.SHOOT_NAME = exports.HEAT_MAP_NAME = exports.POINT_NAME = exports.AREA_NAME = undefined;
...
var SHOOT_NAME = exports.SHOOT_NAME = 'WidgetsMapShoot';
...
exports.default = {
  ...
  changeData: function changeData(chart, newConfig, viewName, newData) {
    var config = (0, _merge2.default)({}, this.defaultConfig, newConfig);
    var ds = this.ds;
...
function drawMapPoint(chart, ds, config, data) {
  ...
  if (pointMapDataView) {
    ...
    var sizeConfig = (0, _geomSize2.default)(config.size, 4, 'value', 'name*value');
    ...
    if (config.labels || config.label) {
      ...
      pointGeom.label('name', {
        offset: '' + (offset - Number(_index2.default['widgets-font-size-1'].replace('px', ''))),
        textStyle: _extends({
          fill: _index2.default['widgets-map-label'],
          // 需要去掉 px 的字符串
          fontSize: _index2.default['widgets-font-size-1'].replace('px', ''),
          textBaseline: 'middle'
        }, textStyle),
...
function drawHeatMap(chart, ds, config, data) {
  ...
  if (heatMapDataView) {
    ...
    var sizeConfig = (0, _geomSize2.default)(config.size, 16, 'value', 'name*value');
...
function drawMapLabel(chart, config) {
  ...
  labelMapView.point().position('x*y').size(0).label('name', {
    ...
    textStyle: function textStyle(name) {
      var fontSize = _index2.default['widgets-font-size-1'].replace('px', '');
      // 对一些尺寸非常小的形状特殊处理，以显示出来。
