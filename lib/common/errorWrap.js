...
export default /*#__PURE__*/function errorWrap(Component) {
  var ErrorBoundary = function (_React$Component) {
    ...
    ErrorBoundary.prototype.render = function render() {
      ...
      return React.createElement(Component, _extends({ ref: forwardedRef }, rest));
    };
  ...
  if (React.forwardRef) {
    var forwardRefFunc = function forwardRefFunc(props, ref) {
      return React.createElement(ErrorBoundary, _extends({}, props, { forwardedRef: ref }));
    };
    var result = React.forwardRef(forwardRefFunc);
