...
exports.default = function (chart, config, componentConfig, isOneDataGroup) {
  ...
  if (config.legend !== false) {
    ...
    var legendStyle = position === 'bottom' ? { bottom: 0 } : { top: _index.size.s3 };
    if (align === 'right') {
      legendStyle.right = 0;
    } else if (align === 'left') {
      legendStyle.left = 0;
    ...
    var legendConfig = {
      ...
      'g2-legend-list': _g2Theme.legendHtmlList,
      'g2-legend-list-item': _g2Theme.legendHtmlListItem,
      'g2-legend-marker': _g2Theme.legendHtmlMarker
    };
