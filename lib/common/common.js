...
export { _isEqual as isEqual };
import _isEqualWith from 'lodash/isEqualWith';
export { _isEqualWith as isEqualWith };
import _merge from './merge';
export { _merge as merge };


export var requestAnimationFrame = window && window.requestAnimationFrame || G2.DomUtil.requestAnimationFrame;
 ...
 * */
export function numberDecimal(num) {
