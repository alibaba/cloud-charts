...
require('@antv/data-set/lib/api/statistics'); // connectors


require('@antv/data-set/lib/connector/default'); // require('@antv/data-set/lib/connector/dsv');
...
require('@antv/data-set/lib/connector/graph'); // require('@antv/data-set/lib/connector/hexjson');


require('@antv/data-set/lib/connector/hierarchy'); // require('@antv/data-set/lib/connector/topojson');
// transforms
// static
...
require('@antv/data-set/lib/transform/subset'); // imputation
...
require('@antv/data-set/lib/transform/bin/histogram'); // require('@antv/data-set/lib/transform/bin/quantile');


require('@antv/data-set/lib/transform/bin/rectangle'); // geo
...
require('@antv/data-set/lib/transform/geo/region'); // diagram


require('@antv/data-set/lib/transform/diagram/arc'); // require('@antv/data-set/lib/transform/diagram/dagre'); // 默认不引入


require('@antv/data-set/lib/transform/diagram/sankey'); // require('@antv/data-set/lib/transform/diagram/voronoi');
// hierarchy
...
require('@antv/data-set/lib/transform/hierarchy/partition'); // require('@antv/data-set/lib/transform/hierarchy/tree');


require('@antv/data-set/lib/transform/hierarchy/treemap'); // tag cloud
