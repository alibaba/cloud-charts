      ...
      oneData.data.forEach(function (d, i) {
        if (Array.isArray(d)) {
          ...
          newData.push((_newData$push = {
            x: x
          }, _newData$push['y' + yIndex] = y, _newData$push.extra = extra, _newData$push.groupExtra = groupExtra, _newData$push.type = dataName, _newData$push));
          ...
          newData.push((_newData$push2 = {
            x: _x
          }, _newData$push2['y' + yIndex] = _y, _newData$push2.extra = [], _newData$push2.groupExtra = groupExtra, _newData$push2.type = dataName, _newData$push2));
        } else {
          var _newData$push3;
          ...
          newData.push((_newData$push3 = {
            x: _x2
          }, _newData$push3['y' + yIndex] = _y2, _newData$push3.extra = _extra, _newData$push3.groupExtra = groupExtra, _newData$push3.type = dataName, _newData$push3));
        }
      });
    });
  } else {
