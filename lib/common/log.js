...
var trackable = window.AiscWidgetsTrackEnable !== false;
/**
 * 打点控制函数
 *
...
setTimeout(function () {
  if (trackable && process.env.NODE_ENV === 'production') {
    ...
    image.src = logUrl + '?version=' + "2.6.20" + '&theme=' + (currentTheme || "index") + '&t=' + Date.now() + '&host=' + (location && location.host) + '&fullurl=' + document.URL + '&chartinit=' + chartInit + '&uamobile=' + isMobile;
  }
}, 3000);