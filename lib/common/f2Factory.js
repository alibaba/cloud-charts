  ...
  var AismChart = (_temp = _class = function (_React$Component) {
    ...
    function AismChart(props, context) {
        ...
        if (dir === 'top') {
          ...
          if (isPieChart) {
            legendData[0].data.forEach(function (d, i) {
              ...
              var dotColor = visible ? colors[i] : _theme.color.widgetsLegendUncheck;
            ...
            legendData.forEach(function (i) {
              ...
              legendStr += '\n              <div\n                style="margin-right: 30px; margin-bottom: 12px; white-space: nowrap"\n                data-close=' + (visible ? 'false' : 'true') + '\n                class="legend"\n                data-name=' + (0, _f2Utils.escapeHtml)(i.name) + '\n              >\n                <span style="display: inline-block; box-sizing: border-box;margin-right: 4px;text-align: center;width: 14px;height: 14px;border-radius: 100%;background-color: #fff;border: 1px solid ' + (visible ? dotColor : _theme.color.widgetsLegendUncheck) + '">\n                  <span style="display: inline-block; width: 10px;height: 10px; border-radius: 100%;background-color:' + (visible ? dotColor : _theme.color.widgetsLegendUncheck) + '">\n                  </span>\n                </span>\n                ' + legendFormatter(i) + '\n              </div>';
            });
          }
      ...
      _this.filterData = function (visibleItemNames) {
        ...
        var colors = theme.colors;
        var newColorMap = colors.filter(function (c, index) {
          return colorIndexes.indexOf(index) > -1;
        });
        // F2.Global.colors = newColorMap;
        _f2.default.Global.setTheme({
          colors: newColorMap
        });
