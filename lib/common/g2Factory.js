    ...
    _createClass(AiscChart, [{
      ...
      value: function autoResize() {
        ...
        (0, _common.requestAnimationFrame)(function () {
          ...
          if (!(parentSize[0] === _size[0] && parentSize[1] === _size[1])) {
            _this3.setSize(parentSize);

            if (ChartProcess.changeSize) {
              _this3.chart && ChartProcess.changeSize.call(_this3, _this3.chart, props.config, parentSize[0], parentSize[1]);
            } else {
              _this3.chart && _this3.chart.changeSize(parentSize[0], parentSize[1]);
            }
          }
        });
      }
      ...
      value: function afterRender(config) {
        ...
        if (ChartProcess.afterRender || this.afterRenderCallbacks.length > 0) {
          setTimeout(function () {
            if (_this4.chart && ChartProcess.afterRender) {
              ChartProcess.afterRender.call(_this4, _this4.chart, config || _this4.props.config);
            }
