...
function g2Factory(name, Chart) {
  ...
  var AiscChart = function (_React$Component) {
    ...
    AiscChart.prototype.componentWillMount = function componentWillMount() {
    ...
    AiscChart.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
      var _this2 = this;
      ...
      if (changeConfig !== false) {
        ...
        if (changeCustomConfig && !_g2.default.Util.isEqualWith(newConfig, oldConfig, changeCustomConfig.bind(this))) {
          hasConfigChange = true;
        } else if (!changeCustomConfig && !_g2.default.Util.isEqual(newConfig, oldConfig)) {
          hasConfigChange = true;
        }
    ...
    AiscChart.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    AiscChart.prototype.render = function render() {
      ...
      var _props3 = this.props,
          ...
          customChart = _props3.customChart,
          otherProps = _objectWithoutProperties(_props3, ['className', 'style', 'children', 'data', 'width', 'height', 'padding', 'config', 'animate', 'language', 'customChart']);
