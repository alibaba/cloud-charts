  ...
  var CloudCharts = function (_React$Component) {
    ...
    function CloudCharts(props, context) {
      ...
      _this.isEqualCustomizer = function (objValue, othValue, key) {
        ...
        var enableFunctionUpdate = _this.props.enableFunctionUpdate;
    ...
    CloudCharts.prototype.afterRender = function afterRender(config) {
      ...
      if (this.chartProcess.afterRender || this.afterRenderCallbacks.length > 0) {
        this.afterRenderTimer = (0, _common.requestAnimationFrame)(function () {
    ...
    CloudCharts.prototype.render = function render() {
      ...
      var _props2 = this.props,
          ...
          enableFunctionUpdate = _props2.enableFunctionUpdate,
          otherProps = _objectWithoutProperties(_props2, ['className', 'style', 'children', 'data', 'width', 'height', 'padding', 'config', 'event', 'animate', 'language', 'customChart', 'getChartInstance', 'enableFunctionUpdate']);
