...
exports.legendHtmlMarker = exports.legendHtmlListItem = exports.legendHtmlList = exports.legendHtmlContainer = undefined;
...
var legendHtmlContainer = exports.legendHtmlContainer = {
  overflow: 'auto',
  fontFamily: _index.fonts.fontFamilyTxdMediumNumber,
...
var widgetsTheme = {
  ...
  label: {
    textStyle: {
      ...
      fontSize: (0, _common.pxToNumber)(_index.fonts.fontSizeBaseCaption),
      fontFamily: _index.fonts.fontFamilyTxdRegularNumber
    }
  },
  innerLabels: {
    textStyle: {
  ...
  axis: {
    bottom: {
      label: {
        ...
        textStyle: {
          ...
          fontFamily: _index.fonts.fontFamilyTxdRegularNumber // 底部标签文本的颜色
        } },
      line: {
    ...
    left: {
      label: {
        ...
        textStyle: {
          fill: _index.color.widgetsAxisLabel,
          fontFamily: _index.fonts.fontFamilyTxdRegularNumber // 左部标签文本的颜色
        } },
      grid: {
        // 让grid在轴线的下方
        zIndex: -1,
    ...
    right: {
      label: {
        ...
        textStyle: {
          fill: _index.color.widgetsAxisLabel,
          fontFamily: _index.fonts.fontFamilyTxdRegularNumber // 右部标签文本的颜色
        } }
    },
    circle: {
      label: {
