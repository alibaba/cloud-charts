...
var widgetsTheme = {
  ...
  label: {
    textStyle: {
      fill: _normal.color.widgetsAxisLabel
    }
  },
  axis: {
    bottom: {
      label: {
        offset: 18,
        autoRotate: false,
        textStyle: { fill: _normal.color.widgetsAxisLabel // 底部标签文本的颜色
        } },
      line: {
        stroke: _normal.color.widgetsAxisLine
      },
      tickLine: null
    },
    left: {
      label: {
        offset: 8,
        textStyle: { fill: _normal.color.widgetsAxisLabel // 左部标签文本的颜色
        } },
      grid: {
        // 让grid在轴线的下方
        zIndex: -1,
        lineStyle: {
          stroke: _normal.color.widgetsAxisGrid,
          lineWidth: 1,
          lineDash: null
        }
      }
    ...
    right: {
      label: {
        offset: 8,
        textStyle: { fill: _normal.color.widgetsAxisLabel // 右部标签文本的颜色
        } }
    },
    circle: {
      label: {
  ...
  tooltip: {
    offset: 8,
    crossLine: {
      stroke: _normal.color.widgetsTooltipCrossLine
      // lineWidth: 1,
    },
    'g2-tooltip': {
      backgroundColor: _normal.color.widgetsTooltipBackground,
      boxShadow: _normal.color.widgetsTooltipShadow,
      ...
      color: _normal.color.widgetsTooltipText,
      textAlign: 'left'
    },
    'g2-tooltip-title': {
      marginBottom: 0,
      color: _normal.color.widgetsTooltipTitle
    },
    'g2-tooltip-list': {},
  ...
  tooltipMarker: {
    symbol: function symbol(x, y, r, ctx, marker) {
      ctx.fillStyle = _normal.color.widgetsTooltipMarkerFill;
      ctx.lineWidth = 2;
  ...
  tooltipCrosshairsRect: {
    style: {
      fill: _normal.color.widgetsTooltipCrossReact,
      opacity: _normal.color.widgetsTooltipCrossReactOpacity
    }
  },
  ...
  legend: {
    top: {
      textStyle: {
        fill: _normal.color.widgetsLegendText
      },
      unCheckColor: _normal.color.widgetsLegendUncheck
    },
    right: {
      textStyle: {
        fill: _normal.color.widgetsLegendText
    ...
    html: {
      ...
      'g2-legend': {
        ...
        fontSize: _normal.fonts.fontSizeBaseCaption,
        lineHeight: _normal.fonts.fontSizeBaseCaption,
        color: _normal.color.widgetsLegendText
      },
      'g2-legend-list': {},
      'g2-legend-list-item': {
        wordBreak: 'break-all',
