...
exports.legendTextStyle = exports.legendHtmlMarker = exports.legendHtmlListItem = exports.legendHtmlList = exports.legendHtmlContainer = void 0;
...
exports.legendHtmlContainer = legendHtmlContainer;
...
var legendHtmlList = {};
exports.legendHtmlList = legendHtmlList;
...
var legendHtmlListItem = {};
exports.legendHtmlListItem = legendHtmlListItem;
...
var legendHtmlMarker = {};
exports.legendHtmlMarker = legendHtmlMarker;

function getLegendHtmlMarker(themes) {
  var fontSize1 = (0, _common.pxToNumber)(themes['widgets-font-size-1']);
  return {
...
var legendTextStyle = {};
exports.legendTextStyle = legendTextStyle;
...
function getG2ThemeConfig(themes) {
  ...
  return {
    ...
    tooltip: {
      offset: 8,
      crossLine: {
        stroke: themes['widgets-tooltip-cross-line'] // lineWidth: 1,
    ...
    legend: {
      ...
      html: {
        // 注意！ 这个需要和 wmap 中的 G2Map.scss .cloud-charts-map-legend 的样式一致
...
function setG2Theme(themes) {
  Object.assign(legendHtmlContainer, getLegendHtmlContainer(themes));
  Object.assign(legendHtmlList, getLegendHtmlList(themes));
  Object.assign(legendHtmlListItem, getLegendHtmlListItem(themes));
  Object.assign(legendHtmlMarker, getLegendHtmlMarker(themes));
  Object.assign(legendTextStyle, getLegendTextStyle(themes));

  var theme = _g["default"].Util.deepMix({}, _g["default"].Global, getG2ThemeConfig(themes)); // 设置屏幕dpi缩放（如果有效的话）
  ...
  _g["default"].Global.setTheme(theme);
}