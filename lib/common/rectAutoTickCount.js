...
exports.default = function (chart, config, defs, transpose) {
  // X轴&Y轴对应的长度
...
function computerAxis(chart, axisConfig, def, isVertical, len) {
  ...
  var labelFontSize = (0, _common.pxToNumber)(_index2.default['widgets-font-size-1']);
...
function convertFontSize(fontSize) {
  ...
  if ((0, _common.isInvalidNumber)(size)) {
    return (0, _common.pxToNumber)(_index2.default['widgets-font-size-1']);
  } else {
    return Number(size);
  }
}