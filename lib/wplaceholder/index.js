...
var Wplaceholder = (_temp = _class = function (_React$Component) {
  ...
  Wplaceholder.prototype.renderText = function renderText(loading, error) {
  ...
  Wplaceholder.prototype.render = function render() {
    ...
    var mainClasses = (0, _classnames2.default)(prefix, (_classNames = {}, _classNames[prefix + '-loading'] = !error && !!loading, _classNames[prefix + '-error'] = !!error, _classNames[className] = !!className, _classNames));
