...
var Wminicontainer = (_temp = _class = function (_React$Component) {
  ...
  Wminicontainer.prototype.render = function render() {
    ...
    var mainClasses = (0, _classnames2.default)((_classNames = {}, _classNames['' + prefix] = true, _classNames[prefix + '-mobile'] = (0, _platform.isMobileWithProps)(otherProps, isMobile), _classNames[prefix + '-' + (0, _common.getStatusColorName)(status)] = !!status, _classNames[className] = !!className, _classNames));
