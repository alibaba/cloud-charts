...
var Wminicontainer = (_temp = _class = function (_React$Component) {
  ...
  function Wminicontainer() {
    _classCallCheck(this, Wminicontainer);

    return _possibleConstructorReturn(this, (Wminicontainer.__proto__ || Object.getPrototypeOf(Wminicontainer)).apply(this, arguments));
  }
  ...
  _createClass(Wminicontainer, [{
    ...
    value: function render() {
      ...
      var mainClasses = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, '' + prefix, true), _defineProperty(_classNames, prefix + '-' + status, true), _defineProperty(_classNames, className, !!className), _classNames));
