...
var Wminicontainer = (_temp = _class = function (_React$Component) {
  ...
  Wminicontainer.prototype.render = function render() {
    var _classNames;
    ...
    var _props = this.props,
        ...
        otherProps = _objectWithoutProperties(_props, ['height', 'className', 'status', 'style', 'isMobile']);

    var mainClasses = classNames((_classNames = {
      'aisc-widgets': true
    }, _classNames['' + prefix] = true, _classNames[prefix + '-mobile'] = isMobileWithProps(otherProps, isMobile), _classNames[prefix + '-' + getStatusColorName(status)] = !!status, _classNames[className] = !!className, _classNames));
...
}(React.Component), _class.displayName = 'Wminicontainer', _class.defaultProps = {
  status: ''
}, _temp);
Wminicontainer.displayName = 'Wminicontainer';
export { Wminicontainer as default };
