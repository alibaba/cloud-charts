...
var Map = function (_MapBase) {
  ...
  Map.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    _MapBase.prototype.componentWillReceiveProps.call(this, nextProps);
  };
  ...
  Map.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    ...
    return _MapBase.prototype.shouldComponentUpdate.call(this, nextProps, nextState) || newLayer !== oldLayer;
  };
  ...
  Map.prototype.renderSouthChinaSea = function renderSouthChinaSea(config) {
    if (config.showSouthChinaSea === undefined || config.showSouthChinaSea) {
      ...
      var mapColor = fill || _index.color.widgetsMapAreaBg;
