...
var _southChinaSea = require("./southChinaSea");
...
var southChinaSea = (0, _southChinaSea2.default)({
  ...
  fontColor: _normal.color.widgetsMapAreaBg,
  landColor: _normal.color.widgetsMapAreaBg,
  lineColor: _normal.color.widgetsMapAreaBg,
  boxColor: _normal.color.widgetsMapAreaBg,
  islandColor: _normal.color.widgetsMapAreaBg
});
...
var Map = function (_MapBase) {
  ...
  _createClass(Map, [{
    ...
    value: function renderCustomPointLayer(layer) {
      var _this2 = this;
      ...
      return _react2.default.createElement(
        "div",
        { className: "aisc-widgets-map-custom-container", style: layerStyle },
        Array.isArray(data) && data.map(function (d, i) {
          var point = _G2Map.convertPointPosition.call(_this2, d);
          point = _this2.bgMapView.getXY(point);
          var pointStyle = {
            left: point.x,
            top: point.y
          };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        customPointLayer.length > 0 && customPointLayer.map(function (layer) {
          return _this3.renderCustomPointLayer(layer);
        })
      );
    }
  }]);
