...
var Map = function (_MapBase) {
  ...
  Map.prototype.renderSouthChinaSea = function renderSouthChinaSea(config) {
    if (config.showSouthChinaSea === undefined || config.showSouthChinaSea) {
      ...
      return React.createElement(SouthChinaSea, { className: 'aisc-widgets-map-south-china-sea', fontColor: mapColor, landColor: mapColor, lineColor: mapColor, boxColor: mapColor, islandColor: mapColor });
    } else {
      return null;
    }
  };
