...
var MapBase = g2Factory('G2Map', G2Map, false);
...
var Map = function (_MapBase) {
  ...
  function Map(props, context) {
    ...
    _this.convertPosition = function (d) {
      ...
      var point = convertPointPosition.call(_this, d);
  ...
  Map.prototype.renderShootLayer = function renderShootLayer(shootProps, shootIndex) {
    ...
    return React.createElement(Wshoot, _extends({
      key: shootIndex,
  ...
  Map.prototype.renderSouthChinaSea = function renderSouthChinaSea(config) {
    if (config.showSouthChinaSea === undefined || config.showSouthChinaSea) {
      ...
      var mapColor = fill || themes['widgets-map-area-bg'];

      return React.createElement(SouthChinaSea, { key: southChinaSeaKey, className: 'aisc-widgets-map-south-china-sea', fontColor: mapColor, landColor: mapColor, lineColor: mapColor, boxColor: mapColor, islandColor: mapColor });
    } else {
      return null;
    }
  };
  ...
  Map.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement('div', { className: 'aisc-widgets-map-legend', id: this.chartId + '-legend' })
    );
  };
