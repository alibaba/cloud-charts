...
export var Wminiline = G2MiniLine;
export var Wbar = G2Bar;
export var Whistogram = G2Histogram;
export var Wlinebar = G2LineBar;
export var Wpie = G2Pie;
export var Wscatter = G2Scatter;
export var Wmap = G2Map;
export var Wcustom = G2Custom;
export var Wsankey = G2Sankey;
export var Wnightingale = G2Nightingale;
export var Wradar = G2Radar;
export var Wrectangle = G2Rectangle;
export var Wfunnel = G2Funnel;
export var WmultiPie = G2MultiPie;
export var Wbox = G2Box;
export var Wcandlestick = G2Candlestick;
export var Wheatmap = G2Heatmap;
