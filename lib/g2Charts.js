...
export var WG2MiniLine = g2Factory('G2MiniLine', G2MiniLine);
export var WG2Bar = g2Factory('G2Bar', G2Bar);
export var WG2Histogram = g2Factory('G2Histogram', G2Histogram);
export var WG2LineBar = g2Factory('G2LineBar', G2LineBar, false);
export var WG2Pie = g2Factory('G2Pie', G2Pie);
export var WG2Scatter = g2Factory('G2Scatter', G2Scatter);
export var WG2Map = G2Map;
export var WG2Custom = g2Factory('G2Custom', G2Custom);
export var WG2Sankey = g2Factory('G2Sankey', G2Sankey, false);
export var WG2Nightingale = g2Factory('G2Nightingale', G2Nightingale);
export var WG2Radar = g2Factory('G2Radar', G2Radar);
export var WG2Rectangle = g2Factory('G2Rectangle', G2Rectangle, false);
export var WG2Funnel = g2Factory('G2Funnel', G2Funnel);
export var WG2MultiPie = g2Factory('G2MultiPie', G2MultiPie, false);
export var WG2Box = g2Factory('G2Box', G2Box);
export var WG2Candlestick = g2Factory('G2Candlestick', G2Candlestick);
export var WG2Heatmap = g2Factory('G2Heatmap', G2Heatmap);
...
export { PathUtil };
export var Wline = G2Line;
export var Wminiline = WG2MiniLine;
export var Wbar = WG2Bar;
export var Whistogram = WG2Histogram;
export var Wlinebar = WG2LineBar;
export var Wpie = WG2Pie;
export var Wscatter = WG2Scatter;
export var Wmap = WG2Map;
export var Wcustom = WG2Custom;
export var Wsankey = WG2Sankey;
export var Wnightingale = WG2Nightingale;
export var Wradar = WG2Radar;
export var Wrectangle = WG2Rectangle;
export var Wfunnel = WG2Funnel;
export var WmultiPie = WG2MultiPie;
export var Wbox = WG2Box;
export var Wcandlestick = WG2Candlestick;
export var Wheatmap = WG2Heatmap;
