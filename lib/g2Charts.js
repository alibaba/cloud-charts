...
var _G2Nightingale2 = _interopRequireDefault(_G2Nightingale);
...
var _G2Heatmap2 = _interopRequireDefault(_G2Heatmap);
 ...
 * */
var rawGetPointByClient = _g2.default.G.Canvas.prototype.getPointByClient;
// 由于需要运行时this指针，这个函数不可改为箭头函数。
_g2.default.G.Canvas.prototype.getPointByClient = function (clientX, clientY) {
  // 获取原函数返回的坐标值
...
var WG2Nightingale = exports.WG2Nightingale = (0, _g2Factory2.default)('G2Nightingale', _G2Nightingale2.default);
...
var WG2Heatmap = exports.WG2Heatmap = (0, _g2Factory2.default)('G2Heatmap', _G2Heatmap2.default);
...
var Wheatmap = exports.Wheatmap = WG2Heatmap;
