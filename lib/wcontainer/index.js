...
var Wcontainer = (_temp = _class = function (_React$Component) {
  ...
  function Wcontainer() {
    ...
    return _possibleConstructorReturn(this, (Wcontainer.__proto__ || Object.getPrototypeOf(Wcontainer)).apply(this, arguments));
  }
  ...
  _createClass(Wcontainer, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          title = _props.title,
          titleBorder = _props.titleBorder,
          operation = _props.operation,
          className = _props.className,
          style = _props.style,
          otherProps = _objectWithoutProperties(_props, ['height', 'arrange', 'title', 'titleBorder', 'operation', 'className', 'style']);
