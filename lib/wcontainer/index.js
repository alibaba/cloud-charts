...
var Wcontainer = (_temp = _class = function (_React$Component) {
  ...
  Wcontainer.prototype.renderMainNormal = function renderMainNormal(contentStyle) {
  ...
  Wcontainer.prototype.render = function render() {
    ...
    var mainClasses = (0, _classnames2.default)((_classNames = {}, _classNames['' + prefix] = true, _classNames[prefix + '-mobile'] = (0, _platform.isMobileWithProps)(otherProps), _classNames[className] = !!className, _classNames));
