...
var DashBoard = function () {
  function DashBoard(selector, options) {
    ...
    this.defaultOptions = {
      ...
      textColor: _index.color.colorBlack, //仪表盘内部文案
      ...
      boardFontColor: _index.color.colorText12, //刻度盘字体颜色
      boardFontSize: 12, //刻度盘字体大小
      borderColor: _index.color.colorTransparent, //刻度表线颜色
      pointerColor: _index.color.colorText12, //刻度线颜色
      valuePartColor: _index.color.colorB16, //值域颜色
      maxPartColor: _index.color.colorFill12, //刻度盘圆环
      maxValueColor: _index.color.colorTransparent, //最大值标记颜色
      pointOutColor: _index.color.colorTransparent, // 值域刻度颜色
      currentValueColor: _index.color.colorTransparent, //当前值刻度线颜色
      pointerOutterWidth: 8, // 指针包含的外圆半径
      pointerWidth: 90, // 指针针尖相对于圆心半径
      pointerAngle: 0.6 * Math.PI, // 指针两边与圆心角度
      pointerPartColor: _index.color.colorB16, // 指针颜色
      pointerAreaWidth: 0,
      pointerAreaColor: _index.color.colorTransparent,
