...
var DashBoard = /*#__PURE__*/function () {
  function DashBoard(selector, options) {
    ...
    this.defaultOptions = {
      text: '',
      //仪表盘内部文案，不能与指针共存
      textColor: _index["default"].colorBlack,
      //仪表盘内部文案
      ...
      angle: 1.5 * Math.PI,
      //刻度盘角度(包括空余角度)
      boardFontColor: _index["default"].colorText12,
      //刻度盘字体颜色
      boardFontSize: 12,
      //刻度盘字体大小
      borderColor: _index["default"].colorTransparent,
      //刻度表线颜色
      pointerColor: _index["default"].colorText12,
      //刻度线颜色
      valuePartColor: _index["default"].colorB16,
      //值域颜色
      maxPartColor: _index["default"].colorFill12,
      //刻度盘圆环
      maxValueColor: _index["default"].colorTransparent,
      //最大值标记颜色
      pointOutColor: _index["default"].colorTransparent,
      // 值域刻度颜色
      currentValueColor: _index["default"].colorTransparent,
      //当前值刻度线颜色
      ...
      // 指针两边与圆心角度
      pointerPartColor: _index["default"].colorB16,
      // 指针颜色
      pointerAreaWidth: 0,
      pointerAreaColor: _index["default"].colorTransparent,
      dialWidth: 20,
      //刻度盘圆环宽度
      range: [0, 100],
      //取值范围,值域
  ...
  _proto.init = function init() {
    var self = this;
    this.data = this.options.range[0]; //仪表盘
  ...
  _proto.drawDashBoard = function drawDashBoard(data) {
    ...
    this.arcDraw(this.radius, this["default"].startAngle, this["default"].endAngle, this["default"].lineWidth, this.options.borderColor); //值域0以下部分
  ...
  _proto.writeFontText = function writeFontText(tx, ty, A, text) {
    ...
    this.context.font = this.options.boardFontSize + ("px " + _index["default"]['widgets-font-family-txd-m-number']);
