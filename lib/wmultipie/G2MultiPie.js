...
exports.default = _extends({}, _G2Pie2.default, {
  init: function init(chart, userConfig, data) {
    ...
    var source = computeData.call(this, data);
    ...
    _rectLegend2.default.call(this, chart, config, {
      ...
      'g2-legend': {
        ...
        marginLeft: Math.max((0, _common.pxToNumber)(_index.size.s5) - (config.drawPadding || 0), 0) + 'px'
      },
      'g2-legend-list-item': {
        marginRight: 0
      }
    ...
    chart.polygon().position('x*y').color('name').tooltip('name*value*rawValue*depth', function (name, value, rawValue, depth) {
      return {
        name: name,
        value: value
      };
