...
var OnlyLiteralMini = (_temp = _class = function (_React$Component) {
  _inherits(OnlyLiteralMini, _React$Component);

  function OnlyLiteralMini(props) {
    _classCallCheck(this, OnlyLiteralMini);

    var _this = _possibleConstructorReturn(this, (OnlyLiteralMini.__proto__ || Object.getPrototypeOf(OnlyLiteralMini)).call(this, props));

    _this.onClickHealthy = _this.onClickHealthy.bind(_this);
    return _this;
  }

  _createClass(OnlyLiteralMini, [{
    key: 'onClickHealthy',
...
OnlyLiteralMini.displayName = 'OnlyLiteralMini';
