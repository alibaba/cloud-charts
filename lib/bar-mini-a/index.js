...
var BarMiniA = (_temp = _class = function (_React$Component) {
  _inherits(BarMiniA, _React$Component);

  function BarMiniA() {
    _classCallCheck(this, BarMiniA);

    return _possibleConstructorReturn(this, (BarMiniA.__proto__ || Object.getPrototypeOf(BarMiniA)).apply(this, arguments));
  }

  _createClass(BarMiniA, [{
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          details.map(function (detail, index) {
            var data = Math.round(dataSource[detail.key] * 1000) / 10;
...
BarMiniA.displayName = 'BarMiniA';
exports.default = BarMiniA;
