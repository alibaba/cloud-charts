...
var DashBoard = function () {
  function DashBoard(selector, options) {
    ...
    this.defaultOptions = {
      ...
      textColor: _index2.default.colorBlack, //仪表盘内部文案
      ...
      boardFontColor: _index2.default.colorText12, //刻度盘字体颜色
      boardFontSize: 12, //刻度盘字体大小
      borderColor: _index2.default.colorTransparent, //刻度表线颜色
      pointerColor: _index2.default.colorText12, //刻度线颜色
      valuePartColor: _index2.default.colorB16, //值域颜色
      maxPartColor: _index2.default.colorFill12, //刻度盘圆环
      maxValueColor: _index2.default.colorTransparent, //最大值标记颜色
      pointOutColor: _index2.default.colorTransparent, // 值域刻度颜色
      currentValueColor: _index2.default.colorTransparent, //当前值刻度线颜色
      pointerOutterWidth: 8, // 指针包含的外圆半径
      pointerWidth: 90, // 指针针尖相对于圆心半径
      pointerAngle: 0.6 * Math.PI, // 指针两边与圆心角度
      pointerPartColor: _index2.default.colorB16, // 指针颜色
      pointerAreaWidth: 0,
      pointerAreaColor: _index2.default.colorTransparent,
  ...
  DashBoard.prototype.writeText = function writeText(text, unit, url) {
    ...
    this.context.font = textSize + ('px ' + _index2.default['widgets-font-family-txd-m-number']);
    this.context.fillText(text, this.default.x, yArr[0]);
    this.context.restore();
    this.context.save();
    this.context.textAlign = "center";
    this.context.fillStyle = this.options.unitColor;
    this.context.font = this.options.unitSize + ('px ' + _index2.default['widgets-font-family-txd-m-number']);
  ...
  DashBoard.prototype.writeFontText = function writeFontText(tx, ty, A, text) {
    ...
    this.context.font = this.options.boardFontSize + ('px ' + _index2.default['widgets-font-family-txd-m-number']);
