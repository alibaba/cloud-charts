...
var Panel = function (_React$Component) {
  ...
  _createClass(Panel, [{
    ...
    //点击顶部tab
    value: function handleTabClick(key, isActive, e) {
      if (isActive) {
        return;
      }
    ...
    key: 'renderTab',
    value: function renderTab(tabMode, children) {
      var _this2 = this;
...
var PanelItem = (_temp2 = _class2 = function (_React$Component2) {
  _inherits(PanelItem, _React$Component2);

  function PanelItem() {
    _classCallCheck(this, PanelItem);

    return _possibleConstructorReturn(this, (PanelItem.__proto__ || Object.getPrototypeOf(PanelItem)).apply(this, arguments));
  }
  ...
  return PanelItem;
}(_react2.default.Component), _class2.displayName = 'PanelItem', _temp2);
PanelItem.displayName = 'PanelItem';
var PanelTitleSub = (_temp3 = _class3 = function (_React$Component3) {
  _inherits(PanelTitleSub, _React$Component3);

  function PanelTitleSub() {
    _classCallCheck(this, PanelTitleSub);

    return _possibleConstructorReturn(this, (PanelTitleSub.__proto__ || Object.getPrototypeOf(PanelTitleSub)).apply(this, arguments));
  }

  _createClass(PanelTitleSub, [{
    key: 'render',
    value: function render() {
...
}(_react2.default.Component), _class3.displayName = 'PanelTitleSub', _temp3);
