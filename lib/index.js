...
// 业务组件，没有依赖其它图表库
import _Wnumber from './wnumber/index';
export { _Wnumber as Wnumber };
import _Wcontainer from './wcontainer/index';
export { _Wcontainer as Wcontainer };
import _Wicon from './wicon/index';
export { _Wicon as Wicon };
import _Wcircle from './wcircle/index';
export { _Wcircle as Wcircle };
import _Wminicontainer from './wminicontainer/index';
export { _Wminicontainer as Wminicontainer };
import _Wshoot from './wshoot/index';
export { _Wshoot as Wshoot };
import _Wplaceholder from './wplaceholder/index';
export { _Wplaceholder as Wplaceholder };
import _Wperline from './wperline/index';
export { _Wperline as Wperline };
import _Wcount from './wcount/index';
export { _Wcount as Wcount };
import _Wdashboard from './wdashboard/index';
export { _Wdashboard as Wdashboard };
